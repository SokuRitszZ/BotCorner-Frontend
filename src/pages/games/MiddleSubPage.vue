<template>
  <div ref="$middle" class="middle w-full h-full rounded-xl overflow-scroll">
    ...
    <Bar class="w-fit m-auto mt-3 p-1 transition-[0.1s]" :list="['进行中', '录像']" v-model="show_under" />
    <PlayingList @watch="toWatch" v-show="show_under === 0" class="bg-purple-800 mt-3 p-3 rounded-xl w-full h-fit"
      :list_play="list_play" />
    <RecordList v-show="show_under === 1" @play-record="playRecord"
