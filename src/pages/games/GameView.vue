<template>
  <div
    class="min-w-[1600px] w-screen h-screen bg-purple-300 flex flex-col justify-center items-center px-3 py-[80px]"
  >
    <div class="grid grid-cols-9 px-3 min-w-[1600px] w-screen mb-3">
      <div class="h-[50px]"></div>
      <ShowOnline
        class="col-span-7 h-fit bg-purple-500 rounded-xl overflow-scroll"
    ...
    <div class="grid grid-cols-9 w-full h-5/6 gap-3 relative">
      ...
      <!-- middle -->
      <div
        class="col-span-3 flex justify-center bg-purple-700 rounded-3xl p-3 shadow-xl overflow-scroll"
      >
        <MiddleSubPage :promise_server="promise_server" />
      </div>
      <!-- right -->
      <div
        class="col-span-2 bg-purple-500 rounded-3xl shadow-2xl justify-between p-3"
      >
