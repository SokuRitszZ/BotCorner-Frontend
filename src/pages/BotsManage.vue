<template>
  <div class="grid grid-cols-5">
    ...
    <div class="col-span-2 h-screen border-r-[1px] border-gray-300 overflow-scroll">
      <div class="flex justify-between item-center pt-24 pb-8 px-10">
        <div class="text-2xl font-bold">
          我的Bots
        </div>
        <div class="relative">
          <input placeholder="此功能未开放" type="text" class="w-96 border-2 border-purple-400 rounded-md p-1">
        </div>
        <div>
      ...
      <hr>
      <div @click="selectBot(bot)" :key="bot.id" v-for="bot in bots" class="border-b-[1px] px-10 py-4 hover:bg-gray-100 active:bg-gray-200 cursor-pointer">
        <div class="flex justify-between">
          <div class="font-semibold text-purple-500">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-robot inline top-0 relative -translate-y-1"
              viewBox="0 0 16 16">
              <path
          ...
          <div class="text-gray-400 rounded-full text-sm h-fit p-1 font-bold">
            ...
            <svg v-else @click.stop="toggle(bot.id, false)" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-bookmark-star-fill inline"
              viewBox="0 0 16 16">
              <path fill-rule="evenodd"
