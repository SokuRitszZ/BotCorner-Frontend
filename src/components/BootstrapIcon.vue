<template>
  <div :class="props.class">
    ...
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
      class="bi bi-robot inline top-0 relative -translate-y-1"
      viewBox="0 0 16 16"
    >
      <path
    ...
    <svg
      v-else-if="type === 'controller'"
      :width="props.size || 16"
      :height="props.size || 16"
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
      class="bi bi-controller inline"
      viewBox="0 0 16 16"
    >
      <path
